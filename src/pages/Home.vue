  ...
  <div class="mint-footer">
    ...
    <div class="f-bg">
      <mt-tabbar v-model="pageType">
        ...
        <mt-tab-item
          id="order-release"
          @click.native="ch_page('order-release')"
        >
          <img
            v-if="pageType != 'order-release'"
            slot="icon"
        ...
        <mt-tab-item
          class="add"
          id="publish"
          @click.native="ch_page('publish');goPublish()"
        >
          <div>
